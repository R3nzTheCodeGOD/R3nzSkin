	...
	{
		{
			...
			}, true, true, false, 0, &offsets::global::GameClient
		},
		/*{
			{
	...
	{
		{
			...
			}, true, true, false, 0, &offsets::global::Player
		},
		{
			{
				"A1 ? ? ? ? 8B 54 24 14 53 55",
				"8B 0D ? ? ? ? E8 ? ? ? ? 85 C0 74 24 05 ? ? ? ? C2 04 00"
			}, true, true, false, 0, &offsets::global::ManagerTemplate_AIHero_
		},
		{
			{
				"89 1D ? ? ? ? 57 8D 4B 08 89 5C 24 ? C7 03 ? ? ? ? E8 ? ? ? ?",
				"8B 0D ? ? ? ? 83 C1 18 89 14 24 8B 41 04 3B 41 08"
			}, true, true, false, 0, &offsets::global::ChampionManager
		},
		{
			{
				"8B 0D ? ? ? ? E8 ? ? ? ? EB 09",
				"8B 0D ? ? ? ? 8B D0 8B 5C 24 ? 89 54 24 ?"
			}, true, true, false, 0, &offsets::global::ManagerTemplate_AIMinionClient_
		},
		{
			{
				"8B 35 ? ? ? ? 8B 76 18 85 F6 74 ?",
				"89 35 ? ? ? ? 57 68 ? ? ? ? C7 46 04 00 00 00 00 C7 46 08 00 00 00 00"
			}, true, true, false, 0, &offsets::global::ManagerTemplate_AITurret_
		},
		{
			{
				"A3 ? ? ? ? 6A 64 6A 00",
				"FF 35 ? ? ? ? 8B CE E8 ? ? ? ? 8D 44 24 24"
			}, true, true, false, 0, &offsets::global::Riot__g_window
		},
		{
			{
				"8D 8B ? ? ? ? FF 74 24 54",
